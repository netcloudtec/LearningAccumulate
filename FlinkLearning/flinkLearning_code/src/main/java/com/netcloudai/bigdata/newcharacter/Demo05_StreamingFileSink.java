 ...
 */
public class Demo05_StreamingFileSink {
    public static void main(String[] args) throws Exception {
        ...
        if (SystemUtils.IS_OS_WINDOWS || SystemUtils.IS_OS_MAC) {
            env.setStateBackend(new FsStateBackend("file:///data/checkpoint/ckp"));
        } else {
        ...
        StreamingFileSink<String> streamingFileSink = StreamingFileSink.
                forRowFormat(new Path("hdfs://bigdata02:8020/FlinkStreamFileSink/parquet"), new SimpleStringEncoder<String>("UTF-8"))
                .withRollingPolicy(
