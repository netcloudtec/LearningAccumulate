...
/**
 * kafka主题 flink-kafka1 ->
 * Flink-Source -->
 * Flink-Transformation做wordCount
 * 结果存储到kafka主题 flink-Kafka2
 */
public class Demo04_EndToEnd_ExactlyOnce {
    public static void main(String[] args) throws Exception {
        ...
        if (SystemUtils.IS_OS_WINDOWS) {
            env.setStateBackend(new FsStateBackend("/Users/yangshaojun/大数据AI/bigdata_workspace/flink_learning/data"));
        } else {
        ...
        FlinkKafkaConsumer<String> kafkaSource = new FlinkKafkaConsumer<>("flink-kafka1", new SimpleStringSchema(), props);
